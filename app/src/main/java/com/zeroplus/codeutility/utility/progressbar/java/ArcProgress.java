package com.zeroplus.codeutility.utility.progressbar.java;
...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = progressutils.sp2px(getResources(), 18);
        min_size = (int) progressutils.dp2px(getResources(), 100);
        default_text_size = progressutils.sp2px(getResources(), 40);
        default_suffix_text_size = progressutils.sp2px(getResources(), 15);
        default_suffix_padding = progressutils.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = progressutils.sp2px(getResources(), 10);
        default_stroke_width = progressutils.dp2px(getResources(), 4);
