...
public class DonutProgress extends View {
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        default_stroke_width = progressutils.dp2px(getResources(), 10);
        default_inner_bottom_text_size = progressutils.sp2px(getResources(), 18);
    ...
    protected void initInnerBitmap(Context context)
    {
        ...
        {
            bitmap = progressutils.getBitmap(context, attributeResourceId);
        }
    }
